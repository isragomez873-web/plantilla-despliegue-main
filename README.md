...
4.- Crea una copia del archivo .env.example a .env y actualiza tu archivo de env con los datos correspondientes.
...
6.- Consulta el contenido en su navegador
```
 http://localhost/proyecto/
```

7.- Ingreso al phpmyadmin (credenciales en el .env)
```
 http://localhost:8081
```

8.- Revisa los ejemplos contenidos en la carpeta public-html:
...
```bash
openssl passwd -apr1 "psswrd-pr0y3ct0-user!"
```
